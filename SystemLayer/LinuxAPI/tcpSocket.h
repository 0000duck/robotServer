...
struct PagTCP{
    ...
    TCPSOURCETYPE src;      // 消息来源：0:控制器服务端 1:示教器客户端 3:其他客户端设备，例如视觉
...
private:
    ...
    static THREAD_ROUTINE_RETURN recv_msg_file(void* lpParameter);
...
private:
    ...
    static THREAD_ROUTINE_RETURN tcpServerConnect(void* lpParameter);
    void tcpServerClose();
